    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(error_messages={'unique': 'Ya existe un usuario con este nombre, por favor intenta con otro.'}, help_text='Necesario. 150 caracteres o menos. Letras, digitos y @/./+/-/_ solo.', max_length=150, unique=True, validators=[django.contrib.auth.validators.UnicodeUsernameValidator()], verbose_name='username')),
